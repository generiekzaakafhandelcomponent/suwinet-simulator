...
tasks.register("DUODossierStudiefinancieringGSDWsImport") {
    ...
    doLast {
        ant.withGroovyBuilder {
            ...
            "wsimport"(
                "keep" to true,
                "sourcedestdir" to suwinetSourceDir,
                "wsdl" to "${projectDir}/src/main/resources/suwinet/DUODossierStudiefinancieringGSD/Diensten/DUODossierStudiefinancieringGSD/v0200-b01/Impl/BKWI.wsdl",
                "verbose" to true
            ) {
                "xjcarg"("value" to "-XautoNameResolution")
            }
...
tasks.register("DUODossierPersoonGSDWsImport") {
    ...
    doLast {
        ant.withGroovyBuilder {
            ...
            "wsimport"(
                "keep" to true,
                "sourcedestdir" to suwinetSourceDir,
                "wsdl" to "${projectDir}/src/main/resources/suwinet/DUODossierPersoonGSD/Diensten/DUODossierPersoonGSD/v0300-b01/Impl/BKWI.wsdl",
                "verbose" to true
            ) {
                "xjcarg"("value" to "-XautoNameResolution")
            }
