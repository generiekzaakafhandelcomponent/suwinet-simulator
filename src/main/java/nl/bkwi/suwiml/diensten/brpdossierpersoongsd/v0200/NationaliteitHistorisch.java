...
/**
 * <p>Java class for NationaliteitHistorisch complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>{@code
 * <complexType name="NationaliteitHistorisch">
 *   <complexContent>
 ...
 *         <element name="OnjuistGegNationaliteit" type="{http://bkwi.nl/SuwiML/Diensten/BRPDossierPersoonGSD/v0200}OnjuistGeg" minOccurs="0"/>
...
@XmlType(name = "NationaliteitHistorisch", propOrder = {
    "cdNationaliteit",
    "onderzoekGegNationaliteit",
    "onjuistGegNationaliteit",
    "cdBijzonderNederlanderschap",
    "geldigheidGegevensNationaliteit"
})
public class NationaliteitHistorisch {
    ...
    @XmlElement(name = "OnjuistGegNationaliteit")
    protected OnjuistGeg onjuistGegNationaliteit;
    ...
    /**
     * Gets the value of the onjuistGegNationaliteit property.
     * 
     * @return
     *     possible object is
     *     {@link OnjuistGeg }
     *     
     */
    public OnjuistGeg getOnjuistGegNationaliteit() {
        return onjuistGegNationaliteit;
    }

    /**
     * Sets the value of the onjuistGegNationaliteit property.
     * 
     * @param value
     *     allowed object is
     *     {@link OnjuistGeg }
     *     
     */
    public void setOnjuistGegNationaliteit(OnjuistGeg value) {
        this.onjuistGegNationaliteit = value;
    }
