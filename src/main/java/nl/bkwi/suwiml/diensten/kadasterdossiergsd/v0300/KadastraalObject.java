...
/**
 * <p>Java class for KadastraalObject complex type.
 * 
 ...
 *         <element name="KadastraleAanduiding" type="{http://bkwi.nl/SuwiML/Diensten/KadasterDossierGSD/v0300}KadastraleAanduiding" minOccurs="0"/>
 ...
 *         <element name="Gerechtigde" type="{http://bkwi.nl/SuwiML/Diensten/KadasterDossierGSD/v0300}Gerechtigde" maxOccurs="unbounded"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "KadastraalObject", propOrder = {
    "datToestandKadaster",
...
public class KadastraalObject {
    ...
    @XmlElement(name = "KadastraleAanduiding")
    ...
    @XmlElement(name = "Gerechtigde", required = true)
    protected List<Gerechtigde> gerechtigde;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a {@code set} method for the gerechtigde property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getGerechtigde().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the gerechtigde property.
     */
    public List<Gerechtigde> getGerechtigde() {
        if (gerechtigde == null) {
            gerechtigde = new ArrayList<>();
        }
