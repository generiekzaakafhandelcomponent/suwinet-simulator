 ...
 *         <element name="KadastraleGemeentenaam" type="{http://bkwi.nl/SuwiML/Basisschema/v0801}NaamAdresNederlandAN40" minOccurs="0"/>
...
public class KadastraleAanduiding {
    ...
    @XmlElement(name = "KadastraleGemeentenaam")
